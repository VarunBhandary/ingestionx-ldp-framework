...
@dlt.table(
    name="my_test_catalog.adls_bronze.customers_demo",
    table_properties={
        "quality": "bronze",
...
def customers_demo():
    ...
    return (spark.readStream
            .format("cloudFiles")
            .option("cloudFiles.checkpointLocation", "/Volumes/my_test_catalog/dbdemos_autoloader/raw_data/checkpoint/customers")
            ...
            .load("/Volumes/my_test_catalog/dbdemos_autoloader/raw_data/customers")
...
@dlt.table(
    name="my_test_catalog.adls_bronze.customer_preferences_demo",
    table_properties={
        "quality": "bronze",
...
def customer_preferences_demo():
    ...
    return (spark.readStream
            .format("cloudFiles")
            .option("cloudFiles.checkpointLocation", "/Volumes/my_test_catalog/dbdemos_autoloader/raw_data/checkpoint/customer_preferences")
            ...
            .schema(schema)  # Apply fixed schema for data validation
            .load("/Volumes/my_test_catalog/dbdemos_autoloader/raw_data/customer_preferences")
            .selectExpr("*", "_metadata as source_metadata", "current_timestamp() as _ingestion_timestamp"))
...
dlt.create_streaming_table("my_test_catalog.adls_silver.customers_demo_scd2")
...
dlt.create_auto_cdc_flow(
    target="my_test_catalog.adls_silver.customers_demo_scd2",
