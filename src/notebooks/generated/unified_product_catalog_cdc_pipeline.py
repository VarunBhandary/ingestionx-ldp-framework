...
@dlt.table(
    name="vbdemos.adls_bronze.product_catalog_cdc",
    table_properties={
        "quality": "bronze",
...
def product_catalog_cdc():
    ...
    return (spark.readStream
            .format("cloudFiles")
            .option("cloudFiles.checkpointLocation", "/Volumes/vbdemos/dbdemos_autoloader/raw_data/checkpoint/product_catalog_cdc")
...
dlt.create_streaming_table("vbdemos.adls_silver.product_catalog_cdc_scd2")
